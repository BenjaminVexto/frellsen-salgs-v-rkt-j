...
const COMPANY_COLS =
  "id,name,visma_enhed,cvr,address,city,zip,municipality,customer_type,sources,customer_segment_2,afdeling_nr,last_purchase_date,last_sales_date,last_consumable_sales_date,has_active_equipment,employees,is_public,binding_status,customer_category,afloest_af_company_id,assigned_to,visma_id,visma_delivery_id";
